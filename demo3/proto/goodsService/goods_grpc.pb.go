...
const (
	GoodsService_GetGoodsList_FullMethodName = "/GoodsService/GetGoodsList"
)
...
type GoodsServiceClient interface {
	GetGoodsList(ctx context.Context, in *GetGoodsReq, opts ...grpc.CallOption) (*GetGoodsRes, error)
}
...
func (c *goodsServiceClient) GetGoodsList(ctx context.Context, in *GetGoodsReq, opts ...grpc.CallOption) (*GetGoodsRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetGoodsRes)
	err := c.cc.Invoke(ctx, GoodsService_GetGoodsList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GoodsServiceServer interface {
	GetGoodsList(context.Context, *GetGoodsReq) (*GetGoodsRes, error)
...
func (UnimplementedGoodsServiceServer) GetGoodsList(context.Context, *GetGoodsReq) (*GetGoodsRes, error) {
...
func _GoodsService_GetGoodsList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GoodsService_GetGoodsList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServiceServer).GetGoodsList(ctx, req.(*GetGoodsReq))
	}
